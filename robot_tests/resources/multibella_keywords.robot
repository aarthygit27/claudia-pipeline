...
${MUBE_CIM_PASSWORD}            9XwHVkDt3dXy25112325173
...
MUBE Open Browser And Go To CRM Login Page
    ...
    Wait Until Keyword Succeeds    30 s     5 s    Open Browser    ${MUBE_SERVER}    ${BROWSER}
...
MUBE Verify That Case Attributes Are Populated Correctly
    ...
    MUBE Open Tab    History
    MUBE Check History Old And New Value For Attribute    Customer    ${EMPTY}    ${OPPO_TEST_ACCOUNT}
    ...
    MUBE Check History Old And New Value For Attribute    Contact Person    ${EMPTY}    ${OPPO_TEST_CONTACT}
...
MUBE Verify That New Contact Person Is Send To Crm
    ...
    Wait Until Keyword Succeeds    60 s    10 s    MUBE Open Tab    History
    MUBE Check History Old And New Value For Contact Person Attribute    Email                  ${EMPTY}    noreply@teliasonera.com
