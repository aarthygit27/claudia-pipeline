...
def CSR_session_start():
  ...
  response = s.post(url, json=json_admin, headers=headers, verify=False)
...
def user_session_start():
  ...
  response = s.post(url, json=json_user, headers=headers, verify=False)
...
def user_account_details():
  ...
  response = s.get(url, json=json_user, headers=headers, verify=False)
