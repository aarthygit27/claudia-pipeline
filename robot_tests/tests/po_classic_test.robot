...
Test scenario 10:Training
    ...
    #${order_id}=    Complete Order
    #checking the orchestration plan    ${order_id}
    create order sitpo - Professional Products    Aacon Oy   1   ${prod_1}
    view orchestration plan sitpo
