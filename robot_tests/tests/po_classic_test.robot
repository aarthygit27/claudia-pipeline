...
Test scenario 1:Telia Architect
    ...
    create order sitpo - Professional Products    Betonimestarit Oy   2   ${prod_1}  ${prod_2}
...
Test scenario 19:Operation and Support Service
    ...
    create order sitpo    Betonimestarit Oy
    view orchestration plan sitpo
